...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/crosszay1/noobsploit/main/library.lua"))()
local Window = Library:CreateWindow(Config, game:GetService("CoreGui"))

local Tab1 = Window:CreateTab("Zombie Uprising")
...
heads = State
while heads do wait(2)
for _,v in pairs(game:GetService('Workspace').Zombies:GetDescendants()) do
pcall(function()
v.HumanoidRootPart.Size = Vector3.new(head,head,head)
...
local Slider2 = Section1:CreateSlider("HitBox Size", 0,300,nil,false, function(Value)
head = Value
end)
